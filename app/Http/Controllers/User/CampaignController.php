...
class CampaignController extends Controller
{
    public function index()
    {
        ...
        $campaigns = Campaign::where('user_id', $user->id)->where('whatsapp_account_id', getWhatsappAccountId($user))->with('template')->searchable(['title'])->filter(['status'])->orderBy('id', 'desc')->paginate(getPaginate());
